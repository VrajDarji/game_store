...
function BSell() {
  ...
  return (
    <div className="h-[100vh] w-full bg-black pt-[20vh] px-20 flex flex-col gap-10 ">
      <div className="flex justify-between items-center">
        <h1 className="uppercase text-4xl tracking-wide font-bold text-white">
          best sellers
        </h1>
        <button className="uppercase px-3 py-2 bg-white text-[#8858ed] rounded-3xl">
          view all
        </button>
      </div>
        ...
        {p.map((e) => {
          return (
            <div className="relative text-white max-w-[20vw] flex flex-col justify-center items-center gap-1">
              ...
              <button className="mt-2 w-[90%] bg-[#8858ef] py-1 rounded-3xl text-base capitalize font-semibold">add to cart</button>
            </div>
          );
        })}
      </div>
